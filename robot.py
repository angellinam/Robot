...
constants = {
    ...
    "home": {"id": 8, "color": "#25D1CB"},
    "block": {"id": 1, "color": "#145A77"},
    "dirt": {"id": 2, "color": "#9B9384"},
...
def simulation(shape, density, dirtiness, delay=1e-9, verbose=True):
    ...
    world.set_elements([(5, 4), (10, 1), (5, 1), (6, 1), (1, 3), (1, 4), (1, 5), (1, 6), (1, 7), (1, 8), (1, 10), (2, 4), (2, 5), (2, 6), (2, 7), (2, 10), (3, 10), (3, 4),(3, 5),(3, 6),(3,7),
